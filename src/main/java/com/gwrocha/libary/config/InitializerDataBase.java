...
public class InitializerDataBase {
	...
	private void insertUsers() {
		User user = new User("Gleydson Rocha", "gwrocha", "123456", StatusUser.ACTIVE, Role.USER);
		User admin = new User("Admin", "admin", "admin", StatusUser.ACTIVE, Role.USER, Role.ADMIN);
